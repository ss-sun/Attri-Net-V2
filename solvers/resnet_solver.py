    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            if self.use_wandb:
                ...
                print("Epoch: {}, train_epoch_loss: {}".format(epoch, train_epoch_loss))
            ...
            if best_valid_auc <= valid_auc_mean:
                ...
                if self.use_wandb:
                    ...
                    print("Best valid auc: {}".format(best_valid_auc))
    ...
    def validation(self, max_batches):
        ...
        with torch.no_grad():
            ...
            if self.use_wandb:
                ...
                print("valid_epoch_loss: {}".format(valid_epoch_loss))
            ...
            if self.use_wandb:
                ...
                print("valid_auc_mean: {}".format(valid_auc_mean))
