...
class task_switch_solver(object):
    ...
    def __init__(self, exp_configs, data_loader):
        ...
        if self.mode == "train":
            ...
            if self.lambda_loc > 0:
                self.pseudoMask = self.prepare_pseudoMask()
    ...
    def prepare_pseudoMask(self):
        pseudoMask = {}
        file_path = "/mnt/qb/work/baumgartner/sun22/github_projects/tmi/data/pseudo_masks.json"
    ...
    def train(self):
        ...
        for gen_iterations in range(0, self.num_iters):
            ...
            psydo_mask = self.pseudoMask[self.current_training_disease]
            ...
            localization_loss += self.psydo_local_loss(pos_masks, psydo_mask)
