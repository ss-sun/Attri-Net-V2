...
python3 main_attrinet.py --guidance_mode 'no_guidance' --dataset "nih_chestxray" --lambda_critic 1 --lambda_1 0 --lambda_2 0 --lambda_cls 100 --lambda_centerloss 0 --lambda_localizationloss 0 --num_iters 100000
