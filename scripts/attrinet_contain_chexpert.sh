...
python3 main_attrinet.py --debug "False" --guidance_mode 'no_guidance' --guidance_freq 0 --dataset "contaminated_chexpert" --lambda_localizationloss 0 --num_iters 100000
