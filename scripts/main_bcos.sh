...
#SBATCH --array=1,2,3,4   # dataset index
...
python3 main_bcos.py --guidance_mode "pseudo_mask" --dataset_idx 0  --lambda_localizationloss ${SLURM_ARRAY_TASK_ID} --use_wandb "False"
