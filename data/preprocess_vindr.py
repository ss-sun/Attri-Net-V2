...
# download vindr-cxr dataset from physionet https://physionet.org/content/vindr-cxr/1.0.0/
# I put original dataset in dir /mnt/qb/rawdata/vindr-cxr-physionet-original/1.0.0, and inside this dir, there are 3 folders: train, test, annotations.
# The following code are used to convert the .dicom files to png files and save them in the same folder structure as the original dataset.
# The following code from https://github.com/vinbigdata-medical/vindr-spinexr/blob/main/spine/preprocess/dicom2png.py
