...
class NIHChestXrayDataModule(LightningDataModule):
    ...
    def __init__(self, dataset_params, split_ratio=0.8, resplit=False, img_size=320, seed=42):
        ...
        self.withBB_image_dir = dataset_params["withBB_image_dir"]
    ...
    def setup(self):
        ...
        self.BBox_test_set = NIHChestXray(image_dir=self.withBB_image_dir, df=self.BBox_test_df, train_diseases=self.TRAIN_DISEASES, transforms=self.data_transforms['test'], img_size=self.img_size, with_BBox=True)
